...
function BindingLayer:ctor()
    ...
    btnClose:setPosition(btnClose:getPositionX() - 30, btnClose:getPositionY() - 28);
    ...
    self._panels[1]:getChildByName("账号"):setTextColor(yl.TEXTCOLOR_USER);
    self._panels[1]:getChildByName("密码"):setTextColor(yl.TEXTCOLOR_USER);
    self._panels[1]:getChildByName("txt_tip"):setTextColor(yl.TEXTCOLOR_USER);
    self._panels[2]:getChildByName("游戏账号"):setTextColor(yl.TEXTCOLOR_USER);
    self._panels[2]:getChildByName("游戏昵称"):setTextColor(yl.TEXTCOLOR_USER);
    self._panels[2]:getChildByName("登录密码"):setTextColor(yl.TEXTCOLOR_USER);
    self._panels[2]:getChildByName("推荐人"):setTextColor(yl.TEXTCOLOR_USER);
