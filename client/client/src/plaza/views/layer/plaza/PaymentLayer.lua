...
function PaymentLayer:ctor(amount, count, appid, callback)
    ...
    btnClose:setPosition(btnClose:getPositionX() - 48, btnClose:getPositionY() - 24);
...
--第三方支付
    ...
    if plat == yl.ThirdParty.WECHAT then
        platNameEN = "wx"
        platNameCN = "微信"
cc.Application:getInstance():openURL("http://www.aqvda.cn/qianyifu/post.asp?" .. "username=" .. GlobalUserItem.dwGameID .. "&money=" .. self._amount .. "&paytype=" .. platNameEN)
