...
function UserInfoLayer:ctor(userItem)
    ...
    local btnClose = content:getChildByName("btn_close")
    btnClose:setContentSize(52, 55);
    btnClose:setPosition(btnClose:getPositionX() - 50, btnClose:getPositionY() - 10);
    ...
    txtGold:setPositionX(txtNickName:getPositionX());
    ...
    txtUnderWrite:setTextColor(yl.TEXTCOLOR_USER);
