...
function NoticeLayer:ctor()
    ...
    btnClose:setPosition(btnClose:getPositionX() - 48, btnClose:getPositionY() - 2);
...
function NoticeLayer:tableCellAtIndex(view, idx)	
    ...
    self._titleeFontConfig = string.getConfig(appdf.DEF_FONT, 24)
    self._titleeFontConfig.upperEnSize = 16
    title:setString(string.EllipsisByConfig(notice.Subject, 200, self._titleeFontConfig))
