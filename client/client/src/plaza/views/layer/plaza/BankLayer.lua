...
function BankLayer:ctor()
    ...
    btnBack:setContentSize(215, 79);
    btnBack:setPosition(cc.p(0, 94))
    btnBack:setAnchorPoint(cc.p(0, 1.0));
...
--    print("******************** end :");
    ...
    if index == Categorys.Take then         --取款
        ...
        panel:getChildByName("取款数量："):setTextColor(cc.c3b(0xff, 0xc6, 0x09));
        panel:getChildByName("银行密码："):setTextColor(cc.c3b(0xff, 0xc6, 0x09));
    elseif index == Categorys.Save then     --存款
        ...
        panel:getChildByName("存款数量："):setTextColor(cc.c3b(0xff, 0xc6, 0x09));
    elseif index == Categorys.Transfer then --赠送
        ...
        panel:getChildByName("赠送ID："):setTextColor(cc.c3b(0xff, 0xc6, 0x09));
        panel:getChildByName("赠送数量："):setTextColor(cc.c3b(0xff, 0xc6, 0x09));
        panel:getChildByName("银行密码："):setTextColor(cc.c3b(0xff, 0xc6, 0x09));
...
function BankLayer:tableCellAtIndex(view, idx)	
    ...
    if nil == cell then
        ...
        for i = 1, 5 do
            ...
            txtColumn:setColor(cc.c3b(255, 255, 255))
