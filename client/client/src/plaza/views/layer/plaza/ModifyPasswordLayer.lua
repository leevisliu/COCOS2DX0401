...
function ModifyPasswordLayer:ctor()
    ...
    btnClose:setPosition(btnClose:getPositionX() - 24, btnClose:getPositionY() - 25);
    ...
    for k, v in ipairs(self._content:getChildren()) do 
        print(v :getName());
    end 
    self._content:getChildByName("txt_prompt_old_pwd"):setTextColor(yl.TEXTCOLOR_USER);
    self._content:getChildByName("txt_prompt_new_pwd_1"):setTextColor(yl.TEXTCOLOR_USER);
    self._content:getChildByName("txt_prompt_new_pwd_2"):setTextColor(yl.TEXTCOLOR_USER);
