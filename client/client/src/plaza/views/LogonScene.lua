...
--获取验证码
function LogonScene:onGetPhoneCode(szMobile)

	--参数记录
	self._szMobile = szMobile
	showPopWait()
	self._Operate = 1
...
--绑定手机
function LogonScene:onBindingPhone(szMobile,szSMSCode,szBindingAccount)

	--参数记录
	self._szMobile = szMobile
	self.szSMSCode = szSMSCode
	showPopWait()
	self._Operate = 1
