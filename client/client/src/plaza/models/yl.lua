...
--http请求链接地址
--yl.HTTP_URL								= "http://wz.game3778.com" --@http_url
--yl.HTTP_URL								= "http://wz.game3778.com" --@http_url
...
--客服QQ
yl.SERVICE_QQ                           = 1615953562
--客服电话
yl.SERVICE_PHONE                        = 1615953562
...
yl.SUB_MB_REGISTER_GETCODE				= 6				--获取验证码
yl.SUB_MB_BINDING_PHONE 				= 7				--绑定手机
yl.SUB_MB_GET_PHONE_NNUMBER 			= 8				--获取手机号
yl.SUB_MB_UNBINDING_PHONE 		    	= 9				--取消绑定手机
...
yl.WeChat = 
{
	AppID 								= "wx8f35fb62ac5ffa60", --@wechat_appid_wx
	AppSecret 							= "a02e397be1c20c8a4dac46422d68a526", --@wechat_secret_wx
	-- 商户id
...
yl.AliPay = 
{
	...
	-- ios支付宝Schemes
	AliSchemes							= "game762ali", --@alipay_schemes_zfb
}
...
{
    --商户支付密钥
	PayKey 								= "856EB76C31DAA91D10A5CA33B9503BFD", --@jft_paykey_jtpay
	--商户id											
	PartnerID 							= "10221733", --@jft_partnerid_jtpay
	...
	--appid				
	JftAppID							= "20171124202832604487", --@jft_appid_jtpay								
	JftAesKey							= "10940cfedc5a65dd19ce5fd494958173", --@jft_aeskey_jtpay
	JftAesVec 							= "73d3c75cb85e282f", --@jft_aesvec_jtpay
}
...
yl.TEXTCOLOR_USER = cc.c3b(0xff, 0xff, 0xff);
